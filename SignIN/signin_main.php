                ...
                <div class="sign-in">
                    ...
                    <form class="sign-in__form">
                        <div class="form__name form__box">
                            <input type="text" class="name__input input" required="" value = "<?=$_COOKIE['username']?>">
                            <label> User name </label>
                        </div>

                        <div class="form__password form__box">
                            <input type="password" class="password__input input" required="" value = "<?php $_COOKIE['password']; ?>">
                            <label> Password </label>
                        </div>
                
                        <a class="form__btn" href=""> 
                            <span></span>
                            <span></span>
                            <span></span>
                            <span></span>
...
<script src="assets/singin.js"></script>
</body>
</html>