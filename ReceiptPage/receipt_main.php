      ...
      <div class="background-cover">
        ...
        <main class="main">
          <div class="receipt-block">
            <img class="receipt__img" width="1024px" src="../assets/img/loading.jpg" alt="">
            <h1 class="receipt__title"> </h1>
            <p class="receipt__txt"> 
          ...
          <div class="author-block">
            <img src="../assets/img/loading.jpg" width="100px" height="100px" alt="" class="author__img">
            <div class="author__info">
              <p class="author__name"> </p>
              <a href="" class="author__email"></a>
          ...
          <script>
              ...
              document.getElementsByClassName("author-block")[0].style.backgroundImage = `linear-gradient( ${getRandomInt(0, 180)}deg, #${getRandomColour()} ${getRandomInt(0, 100)}%, #${getRandomColour()} ${getRandomInt(0, 100)}%)`;
          </script>
