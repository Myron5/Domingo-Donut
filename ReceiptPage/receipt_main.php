            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item nav-pod">
                    <a class="cat-f" href="../SignUP/signup_main.html">Sign up<img src="../assets/img/add-user.png" alt="" class="icon_hed"></a>  <!--nav-link для стилю-->
                  </li>
                  <li class="nav-item nav-pod">
...
<div class="container">
    ...
    <div class="container card-block col-md-10">                   <!--CARD style="width: 50rem;"-->
          ...
          <div class="row gy-4 gx-5">
              ...
              <div class="col-lg-2 col-md-6">
                  ...
                  <ul class="list-unstyled text-muted">
                      ...
                      <li><a href="../SignIN/signin_main.php" class="social">Sign in</a></li>
                      <li><a href="../SignUP/signup_main.html" class="social">Sign up</a></li>
...
<script src="assets/processing_4.js"></script>  
</body>
</html>